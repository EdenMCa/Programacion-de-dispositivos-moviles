...
const listQuestions = [
  ...
  Question(
    textQuestion:
        "¿Quién es el piloto más joven en ganar un Gran Premio de F1?",
    answers: [
      "Max Verstappen",
      "Sebastian Vettel",
      "Fernando Alonso",
  ...
  Question(
    textQuestion:
        "¿Qué equipo ha ganado más campeonatos de constructores en la F1?",
    answers: ["Ferrari", "McLaren", "Mercedes", "Williams"],
    correctAnswer: "Ferrari", // 16 títulos de constructores
  ),
  Question(
      textQuestion:
          "¿En qué año ganó Ferrari su último Campeonato de Constructores en la Fórmula 1?",
      answers: ["2019", "2008", "2022", "2013"],
      correctAnswer: "2008"),
  Question(
      textQuestion:
          "¿Qué piloto logró el récord de ser el campeón del mundo más joven en la historia de la F1?",
      answers: [
        "Lewis Hamilton",
        "Sebastian Vettel",
        "Fernado Alonso",
